      ...
      <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 py-3 flex items-center gap-4">
        ...
        <nav className="ml-auto flex items-center gap-1">
          ...
          <NavLink
            href="#/dynamic-peers"
            label="Dynamic peers"
            active={currentRoute === "dynamic-peers"}
          >
            <DynamicPeersIcon />
          </NavLink>
          ...
          <NavLink href="#/plugins" label="Plugins" active={currentRoute === "plugins"}>
            <PluginsIcon />
          </NavLink>
...
// PluginsIcon is a stroked puzzle-piece glyph (the conventional
// "plugin / extension" symbol), matching the 18px outline style of
// the other nav icons.
...
// DynamicPeersIcon is a share/topology glyph (three nodes joined to a
// root) — a visual cue for transient, self-registering peers. Stroked
// at the nav button's standard 18px to match the other icons.
function DynamicPeersIcon() {
  return (
    <svg
      width="18"
      height="18"
    ...
    >
      ...
      <path d="M12 7v3M12 10 6 17M12 10l6 7" />
    </svg>
  );
}
