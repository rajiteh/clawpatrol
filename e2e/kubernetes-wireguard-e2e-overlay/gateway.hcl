...
# isolated *-e2e namespaces with a short lease so the e2e exercises
# heartbeat + expiry quickly. The overlay mounts this in place of the base
# config via a configMapGenerator with `behavior: replace`.
gateway {
